...
const validateUser = ({
  ...
  if (!name) errors.name = "El nombre es obligatorio.";
    ...
    if (name.length > 50)
      errors.name = "El nombre no puede tener más de 50 caracteres.";
  }
  ...
  if (!birthdate) errors.birthdate = "La fecha de nacimiento es obligatoria.";
    ...
    const ageDif = new Date(today.getTime() - birthdateDate.getTime());
  ...
  if (!nDni) errors.nDni = "El número de DNI es obligatorio.";
    ...
    if (isNaN(Number(nDni)))
      errors.nDni = "El número de DNI debe ser un número.";
    if (Number(nDni) < 0)
      errors.nDni = "El número de DNI no puede ser negativo.";
  }
  ...
  if (!username) errors.username = "El nombre de usuario es obligatorio.";
    ...
    if (username.length > 16)
      errors.username =
        "El nombre de usuario no puede tener más de 16 caracteres.";
  }
  ...
  if (!password) errors.password = "La contraseña es obligatoria.";
    ...
    if (password.length > 16)
      errors.password = "La contraseña no puede tener más de 16 caracteres.";
  }
